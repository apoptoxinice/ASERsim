...
struct ospf6_area
{
    ...
    //list of twod-cost  add by zlw
    struct list *twod_list;
    ...
    struct ospf6_lsdb *lsdb_bak;
    struct ospf6_lsdb *lsdb_self;
    struct ospf6_lsdb *lsdb1; // add haozhiqiang 2016-1-26   for twod

    struct ospf6_route_table *spf_table;
    struct ospf6_route_table *route_table;
    struct ospf6_route_table *spf_table1;     // add haozhiqiang 2016-1-26
// struct ospf6_route_table *route_table1;   // add haozhiqiang 2016-1-26

    struct prefix d_prefix;     //add by zlw 2016-3-14 配置下发的目的前缀
    struct prefix s_prefix;     // add haozhiqiang 2016-1-26 配置下发的源前缀
...
extern struct ospf6_lsdb * lsdb_cpy_router_network(struct ospf6_area *oa);//hzq
extern void Change_Router_meritc(struct ospf6_lsa *lsa, struct ospf6_area *oa);//hzq
extern struct ospf6_route_table *Create_Router_table1(struct ospf6_area *oa);//hzq
extern void save_source_addr_prefix(struct ospf6_lsa *lsa, struct ospf6_area *oa);//hzq
