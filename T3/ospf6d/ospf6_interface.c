...
ospf6_interface_create (struct interface *ifp)
{
    ...
    //sangmeng add here for OSPF+ 16.5.10
    oi->new_lsas_list = ospf6_lsdb_create (oi);
#if 0
    oi->new_lsas_list->hook_add = ospf6_interface_lsdb_hook;
    oi->new_lsas_list->hook_remove = ospf6_interface_lsdb_hook;
#endif
