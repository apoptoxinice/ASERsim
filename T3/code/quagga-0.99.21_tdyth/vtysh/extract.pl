...
$ignore{'"interface tunnel <0-32>"'} = "ignore";
...
$ignore{'"ip access-list WORD"'} = "ignore";
$ignore{'"ipv6 access-list WORD"'} = "ignore";
$ignore{'"address-family ipv4"'} = "ignore";
$ignore{'"address-family ipv4 (unicast|multicast|4over6)"'} = "ignore";
