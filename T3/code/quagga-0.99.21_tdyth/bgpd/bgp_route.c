...
{
    puts("bgp_clear_adj_in");
    zlog_debug("bgp_clear_adj_in");
    struct bgp_table *table;
    struct bgp_node *rn;
    struct bgp_adj_in *ain;
...
int bgp_add_ipv4_to_4over6(struct peer *peer, struct prefix *p, struct in_addr *nexthop,
...
int bgp_del_ipv4_from_4over6(struct peer *peer, struct prefix *p, u_char type, int sub_type)
{
    struct bgp_node *rn;
    struct bgp *bgp;
    struct bgp_info *ri;
...
int bgp_add_4over6_to_ipv4(struct peer *peer, struct prefix *p, struct in_addr *nexthop,
                           uint32_t metric, afi_t afi, safi_t safi, int type, int sub_type,
                           struct prefix_rd *prd)
{
    struct bgp *bgp;
...
int bgp_del_4over6_from_ipv4(struct peer *peer, struct prefix *p, u_char type, int sub_type)
{
    struct bgp_node *rn;
    struct bgp *bgp;
    struct bgp_info *ri;
...
void
bgp_redistribute_4over6_add (struct prefix *p, const struct in_addr *nexthop,
...
{
    zlog_debug("bgp_redistribute_delete");
    struct bgp *bgp;
    struct listnode *node, *nnode;
    afi_t afi;
    struct bgp_node *rn;
...
//added for 4over6 20130301
void
bgp_redistribute_4over6_delete (struct prefix *p, u_char type)
{
    struct bgp *bgp;
    struct listnode *node, *nnode;
    afi_t afi;
...
//added for 4over6 20130301
void
bgp_redistribute_4over6_withdraw (struct bgp *bgp, afi_t afi, int type)
{
    struct bgp_node *rn;
    struct bgp_info *ri;
    struct bgp_table *table;
