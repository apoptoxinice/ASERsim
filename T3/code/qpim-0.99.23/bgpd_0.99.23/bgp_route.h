...
#define BGP_INFO_PLUS_SLEEP     (1 << 13)

//added for 4over6 20130226
    u_char flag_4over6;
#define BGP_4OVER6_ENABLE	1
#define BGP_4OVER6_DISABLE	0
...
extern void bgp_announce_route_plus (struct peer *, afi_t, safi_t);
extern void bgp_announce_route_all (struct peer *);
extern void bgp_announce_route_all_plus (struct peer *);
...
extern void bgp_plus_resotre_sleep_route (struct peer *, afi_t, safi_t);
...
extern int bgp_nlri_parse_4over6 (struct peer *, struct attr *, struct bgp_nlri *);
extern void bgp_add_4over6_to_ipv4(struct peer *peer, struct prefix *p, struct in_addr *nexthop,
                                   uint32_t metric, afi_t afi, safi_t safi, int type, int sub_type,
                                   struct prefix_rd *prd);
extern void bgp_del_ipv4_from_4over6(struct peer *peer, struct prefix *p, u_char type, int sub_type);
#endif
...
extern void route_vty_out_for_bgp_plus (struct vty *, struct prefix *, struct attr *, safi_t, u_int16_t);
