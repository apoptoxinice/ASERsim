...
#define	BGP_FLAG_4OVER6_STARTED_AT_VIF		(1 << 15)//added for 4over6 20130301

//added for 4over6 20130121
    uint16_t table_config;
#define BGP_TABLE_CONFIG_4OVER6			(1 << 0)
    /* BGP Per AF flags */
