...
#if 1
        vty_out(vty, "%sinterface name:%s%s", VNL, name, VNL);
        vty_out (vty, "hello recv nums:%ld bytes:%ld%s", ostats[i].hello_recv_nums, ostats[i].hello_recv_bytes, VNL);
        vty_out (vty, "dbdesc recv nums:%ld bytes:%ld%s", ostats[i].dbdesc_recv_nums, ostats[i].dbdesc_recv_bytes, VNL);
        vty_out (vty, "lsreq recv nums:%ld bytes:%ld%s", ostats[i].lsreq_recv_nums, ostats[i].lsreq_recv_bytes, VNL);
        vty_out (vty, "lsupdate recv nums:%ld bytes:%ld%s", ostats[i].lsupdate_recv_nums, ostats[i].lsupdate_recv_bytes, VNL);
        vty_out (vty, "lsack recv nums:%ld bytes:%ld%s", ostats[i].lsack_recv_nums, ostats[i].lsack_recv_bytes, VNL);

        vty_out (vty, "hello send nums:%ld bytes:%ld%s", ostats[i].hello_send_nums, ostats[i].hello_send_bytes, VNL);
        vty_out (vty, "dbdesc send nums:%ld bytes:%ld%s", ostats[i].dbdesc_send_nums, ostats[i].dbdesc_send_bytes, VNL);
        vty_out (vty, "lsreq send nums:%ld bytes:%ld%s", ostats[i].lsreq_send_nums, ostats[i].lsreq_send_bytes, VNL);
        vty_out (vty, "lsupdate send nums:%ld bytes:%ld%s", ostats[i].lsupdate_send_nums, ostats[i].lsupdate_send_bytes, VNL);
        vty_out (vty, "lsack send nums:%ld bytes:%ld%s", ostats[i].lsack_send_nums, ostats[i].lsack_send_bytes, VNL);
#endif
#if 1
