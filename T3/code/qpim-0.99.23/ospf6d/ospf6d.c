...
#define AS_ZONE_LSDB_TITLE_FORMAT \
  "%s        AS Scoped Zone Database%s%s"
      ...
      )
{
    ...
    vty_out (vty, AS_ZONE_LSDB_TITLE_FORMAT, VNL, VNL, VNL);
    ospf6_lsdb_show (vty, level, NULL, NULL, NULL, o->lsdb_zone);
#endif
