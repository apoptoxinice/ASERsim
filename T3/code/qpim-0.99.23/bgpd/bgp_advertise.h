...
struct bgp_adj_out
{
    ...
    struct bgp_advertise *adv;
    u_int16_t flags;
#define BGP_PLUS_NEW              (1 << 0)
#define BGP_PLUS_WITHDRAW         (1 << 1)
#define BGP_PLUS_ORIGIN           (1 << 2)
};
...
extern void bgp_adj_out_set_plus (struct bgp_node *, struct peer *, struct prefix *,
                                  struct attr *, afi_t, safi_t, struct bgp_info *);
extern void bgp_adj_out_set_for_sleep_peer (struct bgp_node *, struct peer *, struct prefix *,
        struct attr *, afi_t, safi_t, struct bgp_info *);
extern void bgp_adj_out_unset (struct bgp_node *, struct peer *, struct prefix *,
                               afi_t, safi_t);
extern void bgp_adj_out_unset_plus (struct bgp_node *, struct peer *, struct prefix *,
                                    afi_t, safi_t);
extern void bgp_adj_out_unset_for_sleep_peer (struct bgp_node *, struct peer *, struct prefix *,
        afi_t, safi_t);
extern void bgp_adj_out_remove (struct bgp_node *, struct bgp_adj_out *,
                                struct peer *, afi_t, safi_t);
extern void bgp_adv_remove (struct bgp_node *, struct bgp_adj_out *,
                            struct peer *, afi_t, safi_t);
