...
struct zz_control
{
    int vtysh_access_verificate;
    //volatile vtysh_enable_pass;
    int vtysh_enable_pass;
};
...
enum node_type
{
    ...
    IPV4_ACCESS_NODE,    /*Ipv4 access list node*/
    IPV6_ACCESS_NODE,    /*Ipv6 access list node*/
    INTERFACE_NODE,/* Interface mode node. */
    ZEBRA_NODE,			/* zebra connection node. */
    DHCP_NODE,			/* dhcp connection node. */
    ...
    BGP_IP4OVER6_NODE,  /* BGP IPv4 4over6 address family. added for 4over6 20130131*/ //sangmeng mark
    TUNNEL_NODE,		/*add by ccc for tunnel cmd*/
    ...
    IP_NAT_NODE,//added for nat 20130508
...
#define SNMP_STR "snmp config information\n"   //add by limingyuan
...
extern struct zz_control vtysh_passwd_control;
/* "<cr>" global */
