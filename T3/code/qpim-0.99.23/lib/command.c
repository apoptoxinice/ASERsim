       ...
       "Exit current mode and down to previous mode\n")
{
    ...
    case BGP_IPV4_NODE:
    case BGP_IPV4M_NODE:
    case BGP_IP4OVER6_NODE://added for 4over6 20130402 //sangmeng mark
    case BGP_IPV6_NODE:
    case BGP_IPV6M_NODE:
        vty->node = BGP_NODE;
        break;
       ...
       "Displays zebra version\n")
{
    ...
    long uptime = 0;
    vty_out (vty, "SpaceRouter6000 %s (%s).%s", QUAGGA_VERSION, host.name?host.name:"",
             VTY_NEWLINE);
...
void neighbor_linklist_create(void)
{
