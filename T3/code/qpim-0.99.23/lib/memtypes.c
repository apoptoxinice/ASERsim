...
struct memory_list memory_list_zebra[] =
{
    ...
    { MTYPE_RIB,			"RIB"				},
    { MTYPE_TUNNEL,			"4over6 TUNNEL"				},//added for 4over6 20130305
...
struct memory_list memory_list_pim[] =
{
    ...
    { MTYPE_PIM_RP_SET_LIST_NODE,      "PIM rp list node"               },
    { MTYPE_PIM_BOOTSTRAP,             "PIM boot strap"                 },
    { MTYPE_PIM_IP_HEADER,             "PIM ip header"                  },
    { MTYPE_PIM_ADDR_PREFIXLEN_LIST,   "PIM addr prefix list"           },
    { MTYPE_PIM_CRPADV,                "PIM crpadv"                     },
    { MTYPE_PIM_CRP_GROUP_POLICY_LIST, "PIM crp group policy list"      },
    { MTYPE_PIM_OIF,                   "PIM out interface"              },
    { MTYPE_PIM_INTERFACE_MEMBER,      "PIM interface member"           },
    { MTYPE_PIM_ADDR_LIST,             "PIM addr list"                  },
    { MTYPE_PIM_GROUP,                 "PIM group entry"                },
    { MTYPE_PIM_SOURCE,                "PIM source entry"               },
    { MTYPE_PIM_MRT,                   "PIM mrt entry"                  },
    { MTYPE_PIM_UPDOWNSTREAM_IF,       "PIM up down stream interface"   },
    { MTYPE_PIM_ASSERT_IF,             "PIM assert interface"           },
    { MTYPE_PIM_MSG,                   "PIM msg"                        },
    { MTYPE_PIM_RPF,                   "PIM rpf"                        },
    { MTYPE_PIM_STATIC_RP,             "PIM static rp"                  },
    { MTYPE_PIM_ACCEPT_REGISTER,       "PIM accept reigster"            },
    { MTYPE_PIM_RECORD,                "PIM record"                     },
    { MTYPE_PIM_HELLO_PARA,            "PIM hello para"                 },
    { MTYPE_PIM_ASSERT_PARA,           "PIM assert para"                },
    { MTYPE_PIM_RP_PARA,               "PIM rp para"                    },
    { MTYPE_PIM_NEIGH_PARA,            "PIM neigh para"                 },
    { MTYPE_PIM_JOIN_PARA,             "PIM join para"                  },
    { MTYPE_PIM_EXPIRY_PARA,           "PIM expiry para"                },
    { MTYPE_PIM_PRUNEPEND_PARA,        "PIM prune pend para"            },
    { MTYPE_PIM_KEEPALIVE_PARA,        "PIM keepalive para"             },
    { MTYPE_PIM_MRTEXPIRY_PARA,        "PIM mrt expiry para"            },
    { MTYPE_PIM_REGISTERSTOP_PARA,     "PIM register stop para"         },
    { MTYPE_PIM_OTHER,                 "PIM other"                      },
    { -1, NULL },
};
