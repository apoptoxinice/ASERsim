...
//huwei add for recording the interface which has configured a ipv4 adddress
    int ipv4_Address_Configed;
};
...
extern struct interface *if_get_by_name_len_null(const char *ifname, size_t namelen);
