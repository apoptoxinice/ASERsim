...
#if 1 //add 2020
extern void ospf6_lsa_originate_zone (struct ospf6_lsa *lsa, struct ospf6 *o, int flag);
#endif
...
//add 2019 for OSPF+
extern void ospf6_receive_lsa_for_leaving (struct ospf6_neighbor *from,
        struct ospf6_lsa_header *header);
extern void ospf6_install_lsa_for_leaving (struct ospf6_lsa *lsa);
extern void ospf6_install_lsa_for_expire(struct ospf6_lsa *lsa);
...
#ifdef TWOD
extern int remove_intra_lsa(struct ospf6_lsa *lsa,struct ospf6_lsdb *lsdb);//hzq
#endif

#if 1 //add 2020
extern u_char drouter_is_self(struct ospf6 *o);
extern int ospf6_process_router_lsa_type_5 (struct ospf6_lsa *lsa, struct ospf6_area *oa);
extern int ospf6_process_pbr_router_lsa (struct ospf6_lsa *lsa, struct ospf6_area *oa);
#endif
