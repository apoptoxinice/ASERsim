...
#if 1 //add 2020
#define OSPF6_PATH_TYPE_PARTITION    5
#endif
...
#if 1 //add 2020
#define OSPF6_DEST_TYPE_AREA       6
#endif
#define OSPF6_DEST_TYPE_MAX        7
...
extern void ospf6_zone_prefix2str (struct prefix *prefix, char *buf, int size);
