...
//add 2020
#define OSPF6_LSTYPE_ZONE             0x400a

#define OSPF6_LSTYPE_E_INTRA_PREFIX     0xA029   //add haozhiqiang 2015-12-17
...
//add for ospf+
extern struct ospf6_lsa *ospf6_lsa_copy_for_expire (struct ospf6_lsa *lsa);
extern struct ospf6_lsa * ospf6_lsa_copy_for_leaving(struct ospf6_lsa *lsa, struct ospf6_interface *oi);

extern void ospf6_lsa_lock (struct ospf6_lsa *);
extern void ospf6_lsa_unlock (struct ospf6_lsa *);
extern void ospf6_lsa_unlock_for_leaving (struct ospf6_lsa *);
void ospf6_lsa_unlock_for_expire (struct ospf6_lsa *lsa);
