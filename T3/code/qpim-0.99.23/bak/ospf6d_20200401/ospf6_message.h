...
enum event { OSPF6_SERV, OSPF6_READ};
...
typedef struct satellite_predict_list
{
    struct satellite_msg_all stl_msg_all;
    struct satellite_predict_list *next;
} stl_link_node, *stl_link_list;

extern stl_link_list stl_link_head;

struct ospf6_packet_stats
{
    unsigned int ifindex;
    unsigned long hello_recv_nums;
    unsigned long hello_recv_bytes;
    unsigned long dbdesc_recv_nums;
    unsigned long dbdesc_recv_bytes;
    unsigned long lsreq_recv_nums;
    unsigned long lsreq_recv_bytes;
    unsigned long lsupdate_recv_nums;
    unsigned long lsupdate_recv_bytes;
    unsigned long lsack_recv_nums;
    unsigned long lsack_recv_bytes;

    unsigned long hello_send_nums;
    unsigned long hello_send_bytes;
    unsigned long dbdesc_send_nums;
    unsigned long dbdesc_send_bytes;
    unsigned long lsreq_send_nums;
    unsigned long lsreq_send_bytes;
    unsigned long lsupdate_send_nums;
    unsigned long lsupdate_send_bytes;
    unsigned long lsack_send_nums;
    unsigned long lsack_send_bytes;
};
#define MAXINTERFACENUM 32
struct ospf6_packet_stats ostats[MAXINTERFACENUM];
...
extern int ospf6_dbdesc_send_newone_for_leaving_to_exchange (struct thread *thread);
