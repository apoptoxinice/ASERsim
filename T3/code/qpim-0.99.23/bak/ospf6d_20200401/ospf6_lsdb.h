...
extern struct ospf6_lsa *ospf6_lsdb_lookup_next (u_int16_t type, u_int32_t id,
        u_int32_t adv_router,
        struct ospf6_lsdb *lsdb);
#ifdef TWOD //0.99.21 two route
extern void ospf6_lsdb_add_e (struct ospf6_lsa *lsa, struct ospf6_lsdb *lsdb);//hzq
#endif
extern void ospf6_lsdb_add (struct ospf6_lsa *lsa, struct ospf6_lsdb *lsdb);
extern void ospf6_lsdb_add_for_leaving (struct ospf6_lsa *lsa, struct ospf6_lsdb *lsdb);
extern void ospf6_lsdb_add_all_for_leaving (struct ospf6_lsdb *lsdb);
extern void ospf6_lsdb_remove (struct ospf6_lsa *lsa, struct ospf6_lsdb *lsdb);
extern void ospf6_lsdb_remove_for_leaving (struct ospf6_lsa *lsa, struct ospf6_lsdb *lsdb);
extern void ospf6_lsdb_remove_for_expire (struct ospf6_lsa *lsa, struct ospf6_lsdb *lsdb);
...
extern void ospf6_lsdb_remove_all_for_leaving (struct ospf6_lsdb *lsdb);
...
extern void ospf6_lsdb_add_for_expire (struct ospf6_lsa *lsa, struct ospf6_lsdb *lsdb);
