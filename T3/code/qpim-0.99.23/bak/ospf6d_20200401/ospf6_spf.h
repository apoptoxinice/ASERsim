...
#if 1//add 2020
#define OSPF6_VERTEX_TYPE_ZONE    0x03
#endif
...
#if 1 //add 2020
#define OSPF6_SPF_FLAGS_ZONE_LSA_ADDED           (1 << 8)
#define OSPF6_SPF_FLAGS_ZONE_LSA_REMOVED         (1 << 9)
#endif
static inline void
...
ospf6_lsadd_to_spf_reason (struct ospf6_lsa *lsa)
{
    ...
    case OSPF6_LSTYPE_ZONE:
        reason = OSPF6_SPF_FLAGS_ZONE_LSA_ADDED;
        break;
#endif
    default:
        break;
...
#if 1 //add 2020
    case OSPF6_LSTYPE_ZONE:
        reason = OSPF6_SPF_FLAGS_ZONE_LSA_REMOVED;
        break;
#endif
    default:
        break;
...
#ifdef TWOD
extern void ospf6_spf_calculation_e (u_int32_t router_id,
                                     struct ospf6_route_table *result_table,
                                     struct ospf6_area *oa,
                                     struct ospf6_lsdb *lsdb);//hzq
#endif

extern void ospf6_spf_schedule (struct ospf6 *ospf, unsigned int reason);

#if 1 //add 2020
extern void ospf6_spf_schedule_zone (struct ospf6 *ospf, unsigned int reason);
#endif

#ifdef TWOD
extern void ospf6_spf_schedule_e (struct ospf6_area *oa);//hzq
#endif
